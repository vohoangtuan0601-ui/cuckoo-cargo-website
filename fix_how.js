...
const newCardsHTML = `<div class="how-panel active" id="how-mvv">
        <div class="how-step-card" style="padding: 0 0 28px 0; overflow: hidden; border: 1px solid var(--gray-border); transition: transform 0.3s ease;" onmouseover="this.style.transform='translateY(-6px)'" onmouseout="this.style.transform='translateY(0)'">
          <div style="width: 100%; height: 180px; position: relative; margin-bottom: 32px; border-bottom: 1px solid rgba(0,0,0,0.05);">
            ...
            <div class="step-n" style="top: auto; bottom: -16px; box-shadow: 0 4px 10px rgba(252, 79, 8,0.3); border: 3px solid #fff; width: 32px; height: 32px; font-size: 14px;">1</div>
          </div>
        ...
        <div class="how-step-card" style="padding: 0 0 28px 0; overflow: hidden; border: 1px solid var(--gray-border); transition: transform 0.3s ease;" onmouseover="this.style.transform='translateY(-6px)'" onmouseout="this.style.transform='translateY(0)'">
          <div style="width: 100%; height: 180px; position: relative; margin-bottom: 32px; border-bottom: 1px solid rgba(0,0,0,0.05);">
            ...
            <div class="step-n" style="top: auto; bottom: -16px; box-shadow: 0 4px 10px rgba(252, 79, 8,0.3); border: 3px solid #fff; width: 32px; height: 32px; font-size: 14px;">2</div>
          </div>
        ...
        <div class="how-step-card" style="padding: 0 0 28px 0; overflow: hidden; border: 1px solid var(--gray-border); transition: transform 0.3s ease;" onmouseover="this.style.transform='translateY(-6px)'" onmouseout="this.style.transform='translateY(0)'">
          <div style="width: 100%; height: 180px; position: relative; margin-bottom: 32px; border-bottom: 1px solid rgba(0,0,0,0.05);">
            ...
            <div class="step-n" style="top: auto; bottom: -16px; box-shadow: 0 4px 10px rgba(252, 79, 8,0.3); border: 3px solid #fff; width: 32px; height: 32px; font-size: 14px;">3</div>
          </div>
